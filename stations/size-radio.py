...
class sizeRadio(commands.Cog, name="Size Radio"):
    ...
    async def sizeradio(self,ctx):
        ...
        streamURL = "http://n01.radiojar.com/atr1e8aswa5tv?rj-ttl=5&rj-tok=AAABhvCAFREAHCeppxCAWGQf7g"
        stationApiUrl = "https://proxy.radiojar.com/api/stations/atr1e8aswa5tv/now_playing/"
    ...
    async def updateSong(self, message, url):
        while True:
            nowPlayingurl = url
            async with aiohttp.ClientSession() as session:  # Async HTTP request
                ...
                stationInfo = "Size-Radio"
                stationURL = "https://www.size-radio.com/"
                stationDescription = "#Soul #Funk #Pop #Rock #HipHop"
                nowPlaying = response['title']
                nowPlayingArtist = response['artist']
                nowPlayingArt = response['thumb']
